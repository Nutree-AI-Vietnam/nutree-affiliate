    ...
    <div className="relative z-10 flex flex-col gap-8 px-6 py-10">
      ...
      >
        ...
        <p className="text-center text-xs text-neutral-400 dark:text-neutral-500">
          Chưa có tài khoản?{" "}
          <Link to="/register" className="font-medium text-neutral-600 dark:text-neutral-300 hover:text-neutral-800 dark:hover:text-white transition-colors">
            Đăng ký miễn phí
          </Link>
        </p>
      </div>
...
function SignInView({
  ...
  const field =
    "mt-1.5 h-11 w-full rounded-xl border border-neutral-200 dark:border-white/10 bg-white dark:bg-[#1F1F1F] px-4 text-sm text-neutral-900 dark:text-white placeholder-neutral-400 dark:placeholder-neutral-500 focus:border-[#29B6A1] focus:outline-none focus:ring-2 focus:ring-[#29B6A1]/20 transition";
    ...
    <div className="relative z-10 flex flex-col gap-5 px-6 py-10 animate-[slideUp_0.5s_ease_both]" style={{ animationFillMode: "both" }}>
      ...
      <div className="rounded-xl border border-neutral-200 dark:border-white/10 bg-white dark:bg-[#2D2D2D] p-6 shadow-sm">
        <form className="space-y-4" onSubmit={onSubmit}>
          <label className="block text-sm font-semibold text-neutral-700 dark:text-white">
            Email
          ...
          <button
            disabled={loading}
            className="group flex h-11 w-full items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-[#29B6A1] bg-[#29B6A1] px-4 text-sm font-semibold text-white transition-all hover:bg-[#1D9080] hover:border-[#1D9080] hover:ring-4 hover:ring-[#29B6A1]/20 active:scale-[.98] disabled:opacity-50"
          >
        ...
        <p className="mt-5 text-center text-sm text-neutral-500 dark:text-neutral-400">
          Chưa có tài khoản?{" "}
          <Link className="font-semibold text-[#29B6A1] hover:opacity-80 transition-opacity" to="/register">
            Đăng ký ngay
          </Link>
        </p>
      </div>
