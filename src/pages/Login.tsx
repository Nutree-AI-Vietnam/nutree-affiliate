  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#1F1F1F]">
      ...
      <div className="relative mx-auto w-full max-w-screen-sm">
        ...
        {step === "signin" && (
          <div className="relative z-10 flex flex-col gap-6 px-6 py-10 animate-[slideUp_0.5s_ease_both]" style={{ animationFillMode: "both" }}>
            <div>
              <span className="block font-mono text-xs font-medium uppercase tracking-widest text-[#29B6A1]">
                Nutree Affiliates
              </span>
            ...
            {/* Section 1: Personal Trainer */}
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500">Personal Trainer</span>
                <div className="flex-1 h-px bg-neutral-200 dark:bg-white/10" />
              </div>
              <div className="rounded-xl border border-neutral-200 dark:border-white/10 bg-white dark:bg-[#2D2D2D] p-5 shadow-sm">
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mb-4">Đăng nhập bằng tài khoản Google của bạn.</p>
                <button
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2">
                <span className="text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500">Quản trị viên</span>
                <div className="flex-1 h-px bg-neutral-200 dark:bg-white/10" />
              </div>
              <form onSubmit={signInAdmin} className="rounded-xl border border-neutral-200 dark:border-white/10 bg-white dark:bg-[#2D2D2D] p-5 shadow-sm flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-xs font-medium text-neutral-600 dark:text-neutral-400">Mật khẩu</label>
                  <input
                    type="password"
                    value={adminPassword}
                ...
                <button
                  ...
                  className="h-10 w-full rounded-lg text-sm font-semibold text-white transition-all hover:opacity-90 active:scale-[.98] disabled:opacity-40"
                  style={{ background: "linear-gradient(135deg, #1A4739 0%, #29B6A1 100%)" }}
                >
