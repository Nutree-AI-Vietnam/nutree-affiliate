      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-[#F5F5F5] px-6">
        <div className="w-full max-w-sm">
          ...
          <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-black/5">
            <h2 className="mb-1 text-xl font-extrabold" style={{ color: "#1A4739" }}>Tạo tài khoản 🌱</h2>
            <p className="mb-6 text-sm text-gray-500">Bắt đầu hành trình affiliate của bạn</p>
