            ...
            {STEPS.map((step, i) => (
              <div key={i} className="flex gap-4">
                ...
                <div className="flex-1 pb-2">
                  ...
                  {/* Screenshot — only for step 3 */}
                  {i === 2 && (
                    <div className="mt-3 flex justify-center">
                      <img
                        src="/step3-enter-code.png"
                        alt="Nhập mã giới thiệu trong ứng dụng Nutree"
                        className="rounded-2xl shadow-md w-full max-w-[260px] object-cover"
                      />
                    </div>
                  )}
                </div>
